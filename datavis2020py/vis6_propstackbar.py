...
plt.savefig('Daily Proportion Stacked Bar.png',bbox_extra_artists=(lgd,), bbox_inches='tight')
plt.show()
...
plt.xticks(rotation=90)
plt.savefig('Daily Proportion Stacked Bar No Ir.png' ,bbox_extra_artists=(lgd,), bbox_inches='tight')
plt.show()
